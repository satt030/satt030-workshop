...
if [ -z "$1" ] || [ -z "$2" ]; then
  ...
  echo "  $0 kubeconfigs-encrypted/participant-1-kubeconfig.yaml.enc my-password"
  echo ""
  echo "  # Save to file"
  echo "  $0 kubeconfigs-encrypted/participant-1-kubeconfig.yaml.enc my-password kubeconfig.yaml"
  echo ""
  echo "  # Save and use directly"
  echo "  $0 kubeconfigs-encrypted/participant-1-kubeconfig.yaml.enc my-password my-kubeconfig.yaml"
